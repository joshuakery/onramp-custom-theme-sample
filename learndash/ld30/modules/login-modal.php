	...
	<div class="ld-login-modal-login">
		<div class="ld-login-modal-wrapper">
			...
			<div class="ld-login-modal-form">
				...
				?>
				<div class="ld-forgot-password-link_container">
	...
	if ( $can_register ) :
		...
		<div class="ld-login-modal-register">
			<div class="ld-login-modal-wrapper">
				...
				// 	}
					?>
                    <a href="<?php echo esc_url( get_permalink( get_page_by_path( 'register' ) ) ); ?>" class="orc_register_button"><?php echo esc_html_e( 'Register an Account', 'learndash' ); ?></a>
