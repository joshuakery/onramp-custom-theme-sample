...
class MEC_skins extends MEC_base
{
    ...
    public function tax_query()
    {
        ...
        //Add WP Categories to filter - OnRamp-Custom
        // global $orc_global_cat_to_filter;
        // if ($orc_global_cat_to_filter != "") {
        //     $tax_query[] = array(
        //         'taxonomy'=>'category',
        //         'field'=>'slug',
        //         'terms'=>$orc_global_cat_to_filter
        //     );
        // }
    ...
    public function period($start, $end, $exclude = false)
    {
        ...
        error_log("calling fetch on reload");
        // $dates = apply_filters( 'orc_filter_dates', $dates );
        return $dates;
    }
    ...
    {
        // Apply Wheel Category Query
        // if (isset($_POST["wheel_categories"])) {
        //     // $wheel_cat = sanitize_text_field($_POST["wheel_categories"]);
        //     $atts['category'] = get_category_by_slug($_POST["wheel_categories"]);
        // }
        // $atts['category'] = 50;
        ...
        // if(isset($sf['category']) and trim($sf['category'])) $atts['category'] = 50;
        
        // $atts['category'] = get_category_by_slug($orc_global_cat_to_filter);
        // if ($orc_global_cat_to_filter != "") {
        //     $atts['category'] = get_category_by_slug($orc_global_cat_to_filter);
        // }
